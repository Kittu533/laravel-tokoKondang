            ...
            <div class="flex justify-center gap-24">
                ...
                <div class="">
                    <div class="form-container">
                        <h1 class="fw-bold mt-2 fs-2">Login</h1>
                        ...
                        <form action="{{ route('login') }}" method="POST" id="RegForm">
                            @csrf
                            <div class="ml-6">
                            ...
                            <h2 class="flex justify-end" >Belum punya akun?<a href="{{ route('register') }}" class="text-primary fs-6" >register</a></h2>
