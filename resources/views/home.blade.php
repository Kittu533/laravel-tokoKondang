...
<body class="antialiased ">
  ...
  <section data-aos="fade-right" data-aos-duration="2000">
    ...
    @endforeach
      ...
      <footer class="text-center">
        <h2 class="text-xl font-semibold text-black mt-12 sm:text-3xl"><a href="{{ route('product') }}">Find Out
            More</a></h2>
      </footer>
    </div>
  </section>
  ...
  <!-- About Us -->
  <section id="about" data-aos="fade-right" data-aos-duration="2000">
      ...
      <div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        <div class="slideshow-container relative h-64 overflow-hidden sm:h-80 lg:h-full">
          <img
            ...
            class="slide fade rounded-lg" />
          <img
            src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            class="slide fade rounded-lg" />
          <img
            src="https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?q=80&w=2952&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            class="slide fade rounded-lg" />
        </div>
        <div class="lg:py-16">
          <article class="space-y-4 text-gray-600">
            ...
            <p>
              Kami, Toko Kondang berkomitmen untuk memberikan pengalaman berbelanja yang tak terlupakan kepada pelanggan
              kami.
              Sebagai toko thrift terkemuka, kami tidak hanya menawarkan barang-barang berkualitas tinggi dengan harga
              terjangkau,
              tetapi juga mempersembahkan konsep berbelanja yang berkelanjutan. Dengan memilih barang-barang bekas,
              kami mendukung gerakan untuk mengurangi limbah dan menjaga lingkungan. Kami bangga akan keberagaman
              koleksi kami,
